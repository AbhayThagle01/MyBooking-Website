    ...
    <div className="header">
     ...
     {type!=="list" && <> <h1 className="headerTitle">A lifetime of discounts? It's Genius.</h1>
      <p className="headerDesc">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique dolore magni alias a, sint veniam quas omnis, iste voluptas est exercitationem tempore unde!
      </p>
